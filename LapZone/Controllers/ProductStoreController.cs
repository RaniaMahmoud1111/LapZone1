...
public class ProductStoreController : Controller
{
    ...
    public IActionResult Index(/*string sortBy, int? List<categoriesId>, decimal minprice, decimal maxprice*/)
    {
    ...
    public IActionResult FilterAndSort(string sortBy, List<int> categoriesId, decimal minprice, decimal maxprice)
    {
